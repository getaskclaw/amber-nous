...
> This is the plain-language version of [results/2026-W39.en.md](../../results/2026-W39.en.md), written for smart readers with no AI-benchmarking background. After reading it you should be able to retell the conclusion to a friend without distortion. 中文: [2026-W39-g47-plain.zh.md](2026-W39-g47-plain.zh.md)
...
- **Verify (attribution/defense): Grok pulls ahead, 1/3.** The one win is the hardest case in the bank — full marks, 9/9, on a case where K3 and Step5P both scored zero; only one model in history had ever aced it before. On a second attribution case it scored 13/15, just shy of the all-time record. **At "find the root cause from evidence," it is the strongest brain in the family.**
...
- **Text fixes 0/3, adversarial review 0/2, vision review 0/1: dominated.** But read on — *how* it lost these six cases is the real story of this issue.
...
The hard evidence: this failure reproduced **identically on two independent providers** (CommandCode and Nous Portal) — so the disease is in the model itself, not in any platform. Other models worked normally in the same exam room, so the conditions were fair.
...
"Three AIs sat a practical exam. Grok 4.7 is the best detective of the family and builds as well as the champion — but on seven questions it wrote 'I'll take a look' and handed in an empty page, so it came last. Usable, but only with supervision."
